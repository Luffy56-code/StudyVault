...
const FeaturesSection = () => {
  return (
    <div className='mt-20  '>
      <div className='max-w-6xl px-4 lg:px-0 w-screen mx-auto flex  flex-col gap-10'>
        <h1 className='text-center text-3xl'>Organize study life effortlessly. AI powered search for students.</h1>
        <div className='flex flex-wrap gap-5'>
          <FeatureCard
            icon={<AiOutlineRobot className='text-background bg-accent p-1 rounded-md text-4xl' />}
            title="AI-Powered Search"
            body="Ask in plain language. Find notes, papers & chapters instantly."
          />

          <FeatureCard
            icon={<AiOutlineTags className='text-background bg-accent p-1 rounded-md text-4xl' />}
            title="Auto-Tagging System"
            body="Uploads are automatically organized by semester, unit, chapter & exam type."
          />

          <FeatureCard
            icon={<AiOutlineCloudUpload className='text-background bg-accent p-1 rounded-md  text-4xl' />}
            title="Smart Uploads"
            body="Upload notes & papers with clean auto-naming suggestions."
          />

          <FeatureCard
            icon={<AiOutlineShareAlt className='text-background bg-accent p-1 rounded-md  text-4xl' />}
            title="One-Click Share Links"
            body="Share study files securely with classmates — no manual searching."
          />

          <FeatureCard
            icon={<AiOutlineDashboard className='text-background bg-accent p-1 rounded-md  text-4xl' />}
            title="Organized Study Dashboard"
            body="A clean hub showing subjects, exams, semesters & recent uploads."
          />

          <FeatureCard
            icon={<AiOutlineBulb className='text-background bg-accent p-1 rounded-md  text-4xl' />}
